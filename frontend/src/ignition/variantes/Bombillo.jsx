...
export default function Bombillo({ onEncender }) {
  ...
  return (
    <div className="relative flex flex-col items-center">
      {/* El aparato mide 200x320 fijos: se escala en un envoltorio propio y no
          en el boton, porque ahi el `transform` lo gobierna Framer (whileHover
          / whileTap) y pisaria la escala. La altura tambien cuenta: en un
          telefono apaisado lo que falta es alto, no ancho. */}
      <div className="origin-center scale-[0.78] sm:scale-100 [@media(max-height:560px)]:scale-[0.6]">
        <motion.button
          ref={ref}
          onClick={encender}
